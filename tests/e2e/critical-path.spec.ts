...
test.describe.skip('Automated Critical Path (Future - Firefox Specific)', () => {
  ...
  test('capture link workflow', async () => {
  ...
  test('capture image workflow', async () => {
  ...
  test('capture text selection workflow', async () => {
  ...
  test('capture screenshot workflow', async () => {
  ...
  test('export to PDF workflow', async () => {
  ...
  test('enable/disable site toggle', async () => {
  ...
  test('persistence across browser restarts', async () => {
    // 1. Capture items
    // 2. Close browser
